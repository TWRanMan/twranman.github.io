...
![img](http://twranman.github.io/assets/gatling.resources/gatling1.png)

**图1，JMeter 2.8**

 ![img](http://twranman.github.io/assets/gatling.resources/gatling2.png)
...
![img](http://twranman.github.io/assets/gatling.resources/gatling3.png)
...
Gatling的报表分为两类：GLOBAL和DETAILS，其中GLOBAL主要是请求相关的统计数据，比如每秒请求数，请求成功与失败数等；其中DETAILS主要是请求时间相关的统计数据，比如请求响应时间，请求响应延迟时间等。
 ...
 ![img](http://twranman.github.io/assets/gatling.resources/gatling4.png)
...
![img](http://twranman.github.io/assets/gatling.resources/gatling5.png)
...
项目的CI系统选用的是Jenkins，因为Jenkins有Gatling的插件，所以通过这个插件可以在Jenkins上直接查看Gatling的测试结果，如图6所示。
 ...
 ![img](http://twranman.github.io/assets/gatling.resources/gatling6.png)
